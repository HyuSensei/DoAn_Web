                            ...
                            <div class="table_page table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (is_array($cart) || is_object($cart)) foreach($cart as $id => $row ):  ?>
                                        <tr>
                                            <td class="product_remove"><a href="#"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                            <td class="product_thumb"><a href="product-details-default.php"><img
                                                        src="<?php echo $row['img_main'] ?>"
                                                        alt=""></a></td>
                                            <td class="product_name"><a href="product-details-default.php"><?php echo $row['product_name'] ?></a></td>
                                            <td class="product-price"><?php echo $row['price'] ?></td>
                                            <td class="product_quantity"><label>Quantity</label> <input min="1"
                                                    max="100" value="<?php echo $row['quantity'] ?>" type="number"></td>
                                            <td class="product_total"><?php echo $row['price']*$row['quantity'] ?> đ</td>
                                        </tr> 
                                        <?php endforeach  ?>
