                        ...
                        <div
                            ...
                            <div class="swiper-wrapper">
                                <div class="product-image-thumb-single swiper-slide">
                                    <img class="img-fluid" src="<?php echo $row['img_main'] ?>"
                                        alt="">
                                </div>
                                <div class="product-image-thumb-single swiper-slide">
                                    <img class="img-fluid" src="<?php echo $row['img_extra'] ?>"
                                        alt="">
                                </div>
                                <div class="product-image-thumb-single swiper-slide">
                        ...
                        <div class="product-details-variable">
                            ...
                            <div class="d-flex align-items-center ">
                                ...
                                <div class="product-add-to-cart-btn">
                                    <a href="./component/add_to_cart.php?id=<?php echo $row['id'] ?>" class="btn btn-block btn-lg btn-black-default-hover"
